...
export const MISSION_SCAFFOLDS: Record<string, ActivityScaffold> = {
  ...
  "future-self": {
    stems: [
      ...
      ["What I'd want still there is", "I'd hate to have lost", "The part of my life worth protecting is"],
    ...
    stuck: [
      ...
      ["What do people tend to lose between 15 and 21 without meaning to?", "Which of these would take actual effort to keep?"],
  ...
  "the-through-line": {
    stems: [
      ...
      ["The thread is", "What's true in all three is", "Underneath all of it, I'm someone who"],
    ],
    stuck: [
      ...
      ["One sentence. If it needs a paragraph, it isn't the thread yet.", "Where it leads is the next step's job \u2014 this one is just what's true."],
    ],
  },
  "meaning-letter": {
    stems: [
      ["I'm heading towards", "The direction is", "Even if the details change, I'm still going to be"],
      ["To go that way I'd have to give up", "The thing I'd have to say no to is", "It would probably cost me"],
      ["The people I want still around are", "Keeping them would take", "The one I'd most regret losing is"],
      ["I chose this because", "When it stops feeling true, remember", "The reason underneath it is"],
    ],
    stuck: [
      ["A heading, not a destination \u2014 a direction you could still follow if the plan fell apart.", "Write to your future self, not to a teacher."],
      ["If it costs you nothing, it isn't a direction \u2014 it's a preference.", "What would you have to stop doing, not just start?"],
      ["None of them stay by accident. What does keeping them actually require?", "Name one person, not a category."],
      ["Write it for the week you don't believe it.", "Why this, and not the default path everyone's already on?"],
    ],
  },
};
